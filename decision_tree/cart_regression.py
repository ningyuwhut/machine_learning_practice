...
#在abalone数据集上发现cart树也会遇到无法对样本分类的情形,这种情况应该怎么避免或者说怎么处理
#使用训练集中类别数目最多的类别进行标注是否可行？
#以后要加上
...
#			print "type", type(target), type(target[0])
...
#	testset=[dataset[-1]]
	...
	dataset, target =read_iris_dataset('abalone')
	#trainset_size=105 #iris
	trainset_size=125 #wine
	trainset_size=3000 #abalone
...
#	print "trainset_label", trainset_target
#	print "testset", testset
#	print "testset_label", testset_target
#	print "trainset", len(trainset)
#	print "trainset_label", len(trainset_target)
#	print "testset", len(testset)
#	print "testset_label", len(testset_target)
